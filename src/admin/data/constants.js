export const DOCTORS = [
  { id: 1, name: "د. أحمد الراشد",  specialty: "القلب والأوعية",  exp: 18, patients: 1240, rating: 4.9, days: "الأحد، الثلاثاء، الخميس",   fee: 200, available: true  },
  ...
  { id: 3, name: "د. خالد العتيبي", specialty: "جراحة العظام",     exp: 20, patients: 860,  rating: 4.9, days: "الاثنين، الأربعاء، الخميس", fee: 180, available: true  },
  { id: 4, name: "د. فيصل الحربي",  specialty: "طب العيون",        exp: 16, patients: 720,  rating: 4.7, days: "الأحد، الثلاثاء، السبت",    fee: 160, available: false },
  { id: 5, name: "د. عمر السبيعي",  specialty: "الأسنان التجميلي", exp: 12, patients: 650,  rating: 4.8, days: "السبت، الاثنين، الأربعاء",  fee: 120, available: true  },
  { id: 6, name: "د. منى الشهري",   specialty: "الجلدية والتجميل", exp: 10, patients: 590,  rating: 4.6, days: "الأحد، الأربعاء، الخميس",   fee: 180, available: true  },
];
...
export const EMPTY_BOOKING = {
  name: "", age: "", specialty: "القلب", doctor: "د. أحمد الراشد",
